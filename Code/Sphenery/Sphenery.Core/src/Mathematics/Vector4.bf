...
struct Vector4 : IEquatable<Vector4>, IInterpolatable<Vector4>, IEquatable, IHashable
{
    ...
    /// <param name="right">The <see cref="Vector4"/> to the right of the multiplication operator.</param>
    /// <param name="result">The resulting <see cref="Vector4"/>.</param>
    public static void Multiply(Vector4 left, Vector4 right, out Vector4 result)
    {
        result.X = left.X * right.X;
        result.Y = left.Y * right.Y;
        result.Z = left.Z * right.Z;
    ...
    /// <param name="factor">The scaling factor by which to multiply the vector.</param>
    /// <param name="result">The resulting <see cref="Vector4"/>.</param>
    public static void Multiply(Vector4 vector, float factor, out Vector4 result)
    {
        result.X = vector.X * factor;
        result.Y = vector.Y * factor;
        result.Z = vector.Z * factor;
    ...
    /// <param name="right">The <see cref="Vector4"/> to the right of the division operator.</param>
    /// <param name="result">The resulting <see cref="Vector4"/>.</param>
    public static void Divide(Vector4 left, Vector4 right, out Vector4 result)
    {
        result.X = left.X / right.X;
        result.Y = left.Y / right.Y;
        result.Z = left.Z / right.Z;
    ...
    /// <param name="factor">The scaling factor by which to divide the vector.</param>
    /// <param name="result">The resulting <see cref="Vector4"/>.</param>
    public static void Divide(Vector4 vector, float factor, out Vector4 result)
    {
        result.X = vector.X / factor;
        result.Y = vector.Y / factor;
        result.Z = vector.Z / factor;
    ...
    public static void Transform(Vector2 vector, Quaternion quaternion, out Vector4 result)
    {
        var x2 = quaternion.X + quaternion.X;
        var y2 = quaternion.Y + quaternion.Y;
        var z2 = quaternion.Z + quaternion.Z;
    ...
    /// <param name="quaternion">The quaternion by which to transform the vector.</param>
    /// <param name="result">The transformed <see cref="Vector4"/>.</param>
    public static void Transform(Vector3 vector, Quaternion quaternion, out Vector4 result)
    {
        var x2 = quaternion.X + quaternion.X;
        var y2 = quaternion.Y + quaternion.Y;
        var z2 = quaternion.Z + quaternion.Z;
    ...
    /// <param name="quaternion">The quaternion by which to transform the vector.</param>
    /// <param name="result">The transformed <see cref="Vector4"/>.</param>
    public static void Transform(Vector4 vector, Quaternion quaternion, out Vector4 result)
    {
        var x2 = quaternion.X + quaternion.X;
        var y2 = quaternion.Y + quaternion.Y;
        var z2 = quaternion.Z + quaternion.Z;
    ...
    /// <param name="matrix">The matrix by which to transform the vector.</param>
    /// <param name="result">The transformed <see cref="Vector4"/>.</param>
    public static void Transform(Vector2 vector, Matrix matrix, out Vector4 result)
    {
        Vector4 temp;
    ...
    /// <param name="matrix">The matrix by which to transform the vector.</param>
    /// <param name="result">The transformed <see cref="Vector4"/>.</param>
    public static void Transform(Vector3 vector, Matrix matrix, out Vector4 result)
    {
        Vector4 temp;
    ...
    public static void Negate(Vector4 vector, out Vector4 result)
    {
        result.X = -vector.X;
        result.Y = -vector.Y;
        result.Z = -vector.Z;
    ...
    public static void Clamp(Vector4 vector, Vector4 min, Vector4 max, out Vector4 result)
    {
        result.X = vector.X < min.X ? min.X : vector.X > max.X ? max.X : vector.X;
        result.Y = vector.Y < min.Y ? min.Y : vector.Y > max.Y ? max.Y : vector.Y;
        result.Z = vector.Z < min.Z ? min.Z : vector.Z > max.Z ? max.Z : vector.Z;
    ...
    public static void Min(Vector4 vector1, Vector4 vector2, out Vector4 result)
    {
        result.X = vector1.X < vector2.X ? vector1.X : vector2.X;
        result.Y = vector1.Y < vector2.Y ? vector1.Y : vector2.Y;
        result.Z = vector1.Z < vector2.Z ? vector1.Z : vector2.Z;
    ...
    public static void Max(Vector4 vector1, Vector4 vector2, out Vector4 result)
    {
        result.X = vector1.X < vector2.X ? vector2.X : vector1.X;
        result.Y = vector1.Y < vector2.Y ? vector2.Y : vector1.Y;
        result.Z = vector1.Z < vector2.Z ? vector2.Z : vector1.Z;
    ...
    public static void Reflect(Vector4 vector, Vector4 normal, out Vector4 result)
    {
        var dot = vector.X * normal.X + vector.Y * normal.Y + vector.Z * normal.Z + vector.W * normal.W;
    ...
    public static void Lerp(Vector4 vector1, Vector4 vector2, float amount, out Vector4 result)
    {
        result.X = vector1.X + (vector2.X - vector1.X) * amount;
        result.Y = vector1.Y + (vector2.Y - vector1.Y) * amount;
        result.Z = vector1.Z + (vector2.Z - vector1.Z) * amount;
    ...
    /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
    /// <param name="result">The interpolated <see cref="Vector4"/>.</param>
    public static void Hermite(Vector4 vector1, Vector4 tangent1, Vector4 vector2, Vector4 tangent2, float amount, out Vector4 result)
    {
        var t2 = amount * amount;
        var t3 = t2 * amount;
    ...
    /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
    /// <param name="result">The interpolated <see cref="Vector4"/>.</param>
    public static void SmoothStep(Vector4 vector1, Vector4 vector2, float amount, out Vector4 result)
    {
		var amount;
        amount = amount > 1 ? 1 : amount < 0 ? 0 : amount;
        amount = amount * amount * (3.0f - 2.0f * amount);
    ...
    /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
    /// <param name="result">The interpolated <see cref="Vector4"/>.</param>
    public static void CatmullRom(Vector4 vector1, Vector4 vector2, Vector4 vector3, Vector4 vector4, float amount, out Vector4 result)
    {
        var t2 = amount * amount;
        var t3 = t2 * amount;
    ...
    public static void Distance(Vector4 vector1, Vector4 vector2, out float result)
    {
        var dx = vector2.X - vector1.X;
        var dy = vector2.Y - vector1.Y;
        var dz = vector2.Z - vector1.Z;
    ...
    public static void DistanceSquared(Vector4 vector1, Vector4 vector2, out float result)
    {
        var dx = vector2.X - vector1.X;
        var dy = vector2.Y - vector1.Y;
        var dz = vector2.Z - vector1.Z;
    ...
    public static void Barycentric(Vector4 v1, Vector4 v2, Vector4 v3, float b2, float b3, out Vector4 result)
    {
        var b1 = (1 - b2 - b3);
