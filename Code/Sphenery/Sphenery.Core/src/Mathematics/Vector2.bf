...
struct Vector2 : IEquatable<Vector2>, IInterpolatable<Vector2>, IEquatable, IHashable
{
    ...
    public static void Dot(Vector2 vector1, Vector2 vector2, out float result)
    {
    ...
    public static void Add(Vector2 vector1, Vector2 vector2, out Vector2 result)
    {
        result.X = vector1.X + vector2.X;
        result.Y = vector1.Y + vector2.Y;
    }
    ...
    /// <param name="vector2">The <see cref="Vector2"/> to the right of the subtraction operator.</param>
    /// <param name="result">The resulting <see cref="Vector2"/>.</param>
    public static void Subtract(Vector2 vector1, Vector2 vector2, out Vector2 result)
    {
        result.X = vector1.X - vector2.X;
        result.Y = vector1.Y - vector2.Y;
    }
    ...
    /// <param name="right">The <see cref="Vector2"/> to the right of the multiplication operator.</param>
    /// <param name="result">The resulting <see cref="Vector2"/>.</param>
    public static void Multiply(Vector2 left, Vector2 right, out Vector2 result)
    {
        result.X = left.X * right.X;
        result.Y = left.Y * right.Y;
    }
    ...
    /// <param name="factor">The scaling factor by which to multiply the vector.</param>
    /// <param name="result">The resulting <see cref="Vector2"/>.</param>
    public static void Multiply(Vector2 vector, float factor, out Vector2 result)
    {
        result.X = vector.X * factor;
        result.Y = vector.Y * factor;
    }
    ...
    /// <param name="right">The <see cref="Vector2"/> to the right of the division operator.</param>
    /// <param name="result">The resulting <see cref="Vector2"/>.</param>
    public static void Divide(Vector2 left, Vector2 right, out Vector2 result)
    {
        result.X = left.X / right.X;
        result.Y = left.Y / right.Y;
    }
    ...
    /// <param name="factor">The scaling factor by which to divide the vector.</param>
    /// <param name="result">The resulting <see cref="Vector2"/>.</param>
    public static void Divide(Vector2 vector, float factor, out Vector2 result)
    {
        result.X = vector.X / factor;
        result.Y = vector.Y / factor;
    }
    ...
    public static void Transform(Vector2 vector, Quaternion quaternion, out Vector2 result)
    {
        var x2 = quaternion.X + quaternion.X;
        var y2 = quaternion.Y + quaternion.Y;
        var z2 = quaternion.Z + quaternion.Z;
    ...
    /// <param name="matrix">The matrix by which to transform the vector.</param>
    /// <param name="result">The transformed <see cref="Vector2"/>.</param>
    public static void Transform(Vector2 vector, Matrix matrix, out Vector2 result)
    {
        Vector2 temp;
    ...
    /// <param name="matrix">The matrix by which to transform the vector.</param>
    /// <param name="result">The transformed <see cref="Vector2"/>.</param>
    public static void TransformNormal(Vector2 vector, Matrix matrix, out Vector2 result)
    {
        Vector2 temp;
    ...
    public static void Normalize(Vector2 vector, out Vector2 result)
    {
        var magnitude = (float)Math.Sqrt(
            vector.X * vector.X +
            vector.Y * vector.Y);
    ...
    public static void Negate(Vector2 vector, out Vector2 result)
    {
        result.X = -vector.X;
        result.Y = -vector.Y;
    }
    ...
    public static void Clamp(Vector2 vector, Vector2 min, Vector2 max, out Vector2 result)
    {
        result.X = vector.X < min.X ? min.X : vector.X > max.X ? max.X : vector.X;
        result.Y = vector.Y < min.Y ? min.Y : vector.Y > max.Y ? max.Y : vector.Y;
    }
    ...
    public static void Min(Vector2 vector1, Vector2 vector2, out Vector2 result)
    {
        result.X = vector1.X < vector2.X ? vector1.X : vector2.X;
        result.Y = vector1.Y < vector2.Y ? vector1.Y : vector2.Y;
    }
    ...
    public static void Max(Vector2 vector1, Vector2 vector2, out Vector2 result)
    {
        result.X = vector1.X < vector2.X ? vector2.X : vector1.X;
        result.Y = vector1.Y < vector2.Y ? vector2.Y : vector1.Y;
    }
    ...
    public static void Lerp(Vector2 vector1, Vector2 vector2, float amount, out Vector2 result)
    {
        result.X = vector1.X + (vector2.X - vector1.X) * amount;
        result.Y = vector1.Y + (vector2.Y - vector1.Y) * amount;
    }
    ...
    /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
    /// <param name="result">The interpolated <see cref="Vector2"/>.</param>
    public static void Hermite(Vector2 vector1, Vector2 tangent1, Vector2 vector2, Vector2 tangent2, float amount, out Vector2 result)
    {
        var t2 = amount * amount;
        var t3 = t2 * amount;
    ...
    /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
    /// <param name="result">The interpolated <see cref="Vector2"/>.</param>
    public static void SmoothStep(Vector2 vector1, Vector2 vector2, float amount, out Vector2 result)
    {
		var amount;
        amount = amount > 1 ? 1 : amount < 0 ? 0 : amount;
        amount = amount * amount * (3.0f - 2.0f * amount);
    ...
    /// <param name="amount">A value from 0.0 to 1.0 representing the interpolation factor.</param>
    /// <param name="result">The interpolated <see cref="Vector2"/>.</param>
    public static void CatmullRom(Vector2 vector1, Vector2 vector2, Vector2 vector3, Vector2 vector4, float amount, out Vector2 result)
    {
        var t2 = amount * amount;
        var t3 = t2 * amount;
    ...
    public static void Distance(Vector2 vector1, Vector2 vector2, out float result)
    {
        var dx = vector2.X - vector1.X;
        var dy = vector2.Y - vector1.Y;
    ...
    public static void DistanceSquared(Vector2 vector1, Vector2 vector2, out float result)
    {
        var dx = vector2.X - vector1.X;
        var dy = vector2.Y - vector1.Y;
    ...
    public static void Barycentric(Vector2 v1, Vector2 v2, Vector2 v3, float b2, float b3, out Vector2 result)
    {
        var b1 = (1 - b2 - b3);
