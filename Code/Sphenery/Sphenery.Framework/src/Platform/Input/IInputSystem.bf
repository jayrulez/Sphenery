using Sphenery.Core;
using Sphenery.Framework.Platform.Input.GamePad;
using Sphenery.Framework.Platform.Input.Mouse;
using Sphenery.Framework.Platform.Input.Keyboard;
using Sphenery.Framework.Platform.Input.Touch;
namespace Sphenery.Framework.Platform.Input;

/// <summary>
/// Represents the method that is called when a <see cref="KeyboardDevice"/> is registered
/// with the Sphenery context as a result of receiving input for the first time.
/// </summary>
...
interface IInputSystem
{
	...
	/// </summary>
	bool EmulateMouseWithTouchInput
	{
		get;
		set;
	}
