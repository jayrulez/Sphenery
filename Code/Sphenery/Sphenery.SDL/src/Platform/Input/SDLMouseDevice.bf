...
using Sphenery.Framework.Platform.Input.Mouse;
...
class SDLMouseDevice : MouseDevice, IMessageSubscriber<MessageId>
{
	...
	public override void WarpToWindow(Sphenery.Framework.Platform.Window.IWindow window, int32 x, int32 y)
	{
	...
	public override void WarpToWindowCenter(Sphenery.Framework.Platform.Window.IWindow window)
	{
			//Contract.EnsureNotDisposed(this, Disposed);
			//Contract.Require(window, nameof(window));
	...
	/// <summary>
	/// Gets the Sphenery MouseButton value that corresponds to the specified SDL2 button value.
	/// </summary>
	/// <param name="value">The SDL2 button value to convert.</param>
	/// <returns>The Sphenery MouseButton value that corresponds to the specified SDL2 button value.</returns>
	private static MouseButton GetSpheneryButton(int32 value)
	{
		if (value == 0)
	...
	private void OnMouseButtonDown(ref SDL.MouseButtonEvent evt)
	{
		...
		var button = GetSpheneryButton(evt.button);
