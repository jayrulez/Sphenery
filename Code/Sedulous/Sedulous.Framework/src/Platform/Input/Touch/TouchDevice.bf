...
namespace Sedulous.Framework.Platform.Input.Touch;

using internal Sedulous.Core;
using internal Sedulous.Framework.Platform.Input.Touch;
...
public abstract class TouchDevice : InputDevice
{
    ...
    public abstract Job<int64> RecordDollarGestureAsync();
    ...
    /// </summary>
    public EventAccessor< TouchDownEventHandler> TouchDown {get;} = new .() ~ delete _;

    /// <summary>
    /// Occurs when a touch input ends.
    /// </summary>
    public EventAccessor<  TouchUpEventHandler> TouchUp {get;} = new .() ~ delete _;

    /// <summary>
    /// Occurs when a touch input moves.
    /// </summary>
    public EventAccessor<  TouchMotionEventHandler> TouchMotion {get;} = new .() ~ delete _;

    /// <summary>
    /// Occurs when a touch input is interpreted as a tap.
    /// </summary>
    public EventAccessor<  TouchTapEventHandler> Tap {get;} = new .() ~ delete _;

    /// <summary>
    /// Occurs when a touch input becomes a long press.
    /// </summary>
    public EventAccessor<  TouchLongPressEventHandler> LongPress {get;} = new .() ~ delete _;

    /// <summary>
    /// Occurs when a multiple-finger touch gesture is performed.
    /// </summary>
    public EventAccessor<  MultiGestureEventHandler> MultiGesture {get;} = new .() ~ delete _;

    /// <summary>
    /// Occurs when a $1 gesture is recorded.
    /// </summary>
    public EventAccessor<  DollarGestureRecordedEventHandler> DollarGestureRecorded {get;} = new .() ~ delete _;

    /// <summary>
    /// Occurs when a $1 gesture is performed.
    /// </summary>
    public EventAccessor<  DollarGestureEventHandler> DollarGesture {get;} = new .() ~ delete _;
